...
export async function generateReportDocx({ cliente, mesReferencia, kpis, narrativas, movimentacoes, totalAnexos }) {
    ...
    sections: [
      {
        children: [
          ...
          new Paragraph({
            alignment: AlignmentType.CENTER,
            children: [new TextRun({ text: `Referência: ${mesReferencia}`, size: 18, color: "7A8394" })],
          }),
          new Paragraph({ text: "" }),
